...
import iaau.uims.json.model.ModelSuccessReport;
 ...
 * @author Çağrı Çakır
 */
public class PostSuccessReportResponse extends HttpServlet 
{

    private static JsonSuccessReport jsonGenerationMethodinstance;
    private static final long serialVersionUID = 1L;

    List<ModelSuccessReport> reqList = new ArrayList<ModelSuccessReport>();
    
    public PostSuccessReportResponse() {
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        gsonBuilder.registerTypeAdapter(Object.class, new PostSuccessReportResponse.NaturalDeserializer());
...
//        params = natural.toString();
        ...
        ModelSuccessReport members;
        members = mapper.readValue(params, ModelSuccessReport.class);
        ...
        String year = reqList.get(listSize).getYear();
        String semester = reqList.get(listSize).getSemester();
        ...
        System.out.println("|ID number: "+idnumber+" | Academic Year: "+year+" | Semester: "+semester+"|");

        // Transmition data from generation
        JsonObject generatedJson;
        jsonGenerationMethodinstance = new JsonSuccessReport();
        try{
            generatedJson = jsonGenerationMethodinstance.GenerateSuccessReport(idnumber, year, semester).getAsJsonObject();
            ...
            System.out.println("Generated SuccessReport JSON representation");
            System.out.println("-------------------------------------------------------------------------------------------------");
            System.out.println(generatedJson);
            System.out.println("-------------------------------------------------------------------------------------------------");
            
            mapper.writeValueAsString("Requested Success Report JSON data is generated");
