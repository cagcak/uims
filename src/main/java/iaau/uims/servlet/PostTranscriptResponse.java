...
import iaau.uims.json.model.ModelTranscript;
 ...
 * @author Çağrı Çakır
 */
public class PostTranscriptResponse extends HttpServlet {

    private static JsonTranscript jsonGenerationMethodinstance;
    private static final long serialVersionUID = 1L;

    List<ModelTranscript> reqList = new ArrayList<ModelTranscript>();
    
    public PostTranscriptResponse() {
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        gsonBuilder.registerTypeAdapter(Object.class, new PostTranscriptResponse.NaturalDeserializer());
        ...
        ModelTranscript members;
        members = mapper.readValue(params, ModelTranscript.class);
        ...
        jsonGenerationMethodinstance = new JsonTranscript();
        try {
            generatedJson = jsonGenerationMethodinstance.GenerateTranscriptAsJson(idnumber).getAsJsonObject();
