...
import iaau.uims.json.model.ModelCurrentInfo;
 ...
 * @author Çağrı Çakır
 */
public class PostCurrentInfoResponse extends HttpServlet 
{
    private static JsonCurrentInfo jsonGenerationMethodinstance;
    private static final long serialVersionUID = 1L;

    List<ModelCurrentInfo> reqList = new ArrayList<ModelCurrentInfo>();

    public PostCurrentInfoResponse() {
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        gsonBuilder.registerTypeAdapter(Object.class, new PostCurrentInfoResponse.NaturalDeserializer());
        ...
        ModelCurrentInfo members;
        members = mapper.readValue(params, ModelCurrentInfo.class);
        ...
        jsonGenerationMethodinstance = new JsonCurrentInfo();
        try {
            generatedJson = jsonGenerationMethodinstance.GenerateCurrentInfoAsJson(idnumber).getAsJsonObject();
            ...
            System.out.println("Generated CurrentInfo JSON representation");
            System.out.println("-------------------------------------------------------------------------------------------------");
