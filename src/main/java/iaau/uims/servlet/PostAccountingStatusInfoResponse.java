...
import iaau.uims.json.model.ModelAccountingStatusInfo;
 ...
 * @author Çağrı Çakır
 */
public class PostAccountingStatusInfoResponse extends HttpServlet 
{
    private static JsonAccountingStatusInfo jsonGenerationMethodinstance;
    private static final long serialVersionUID = 1L;

    List<ModelAccountingStatusInfo> reqList = new ArrayList<ModelAccountingStatusInfo>();

    public PostAccountingStatusInfoResponse() {
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        gsonBuilder.registerTypeAdapter(Object.class, new PostAccountingStatusInfoResponse.NaturalDeserializer());
        ...
        ModelAccountingStatusInfo members;
        members = mapper.readValue(params, ModelAccountingStatusInfo.class);
        ...
        jsonGenerationMethodinstance = new JsonAccountingStatusInfo();
        try {
            // Generating JSON object data with specific resultset
            generatedJson = jsonGenerationMethodinstance.GenerateAccountingStatusInfoAsJson(idnumber).getAsJsonObject();
            ...
            System.out.println("Generated AccountingStatusInfo JSON representation");
            System.out.println("-------------------------------------------------------------------------------------------------");
            System.out.println(generatedJson);
            System.out.println("-------------------------------------------------------------------------------------------------");

            mapper.writeValueAsString("Requested AccountingStatusInfo JSON data is generated");
