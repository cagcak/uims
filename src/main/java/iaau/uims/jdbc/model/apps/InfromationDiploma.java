 ...
 * @author Çağrı Çakır
 */
public class InfromationDiploma {
    ...
    private String yea_of_school_graduation;
    ...
    public String getYea_of_school_graduation() {
        return yea_of_school_graduation;
    }

    public void setYea_of_school_graduation(String yea_of_school_graduation) {
        this.yea_of_school_graduation = yea_of_school_graduation;
    }
